...
public class Client implements ActionListener {
   ...
   static JFrame f=new JFrame();
    ...
    public static void main(String[]args){
        new Client();
        //server onde irok agodu but sockets many iga coonection socket to the server
        try{
            Socket s=new Socket("127.0.0.1",6001);//illi server du address ie is localhost and port number
